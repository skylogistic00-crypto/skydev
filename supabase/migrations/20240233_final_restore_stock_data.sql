...
DO $$ BEGIN RAISE NOTICE 'Migration 20240233 disabled - data seeding only'; END $$;

/*
-- Restore stock data dengan struktur kolom yang benar
...
-- Insert sample stock data dengan struktur kolom yang benar
-- Struktur: item_name (dari rename name), jenis_barang (dari rename item_name)
INSERT INTO stock (
  item_name,
  jenis_barang,
  location, 
  ...
  ('Kursi', 'Kursi Kantor Ergonomis', 'Gudang B', 'Unit', 'KRS-ERG-001', 'CV Furniture Jaya', 1200000, 'PPN 11%', 900000, 1200000, '1-1102', 'Persediaan Furniture', 'Kursi kantor ergonomis dengan sandaran', 'SKU-KRS-001', 'BRG-007', 'Ergotec', 'ERG-100'),
  ('Lemari', 'Lemari Arsip 4 Pintu', 'Gudang B', 'Unit', 'LMR-ARS-001', 'CV Furniture Jaya', 2500000, 'PPN 11%', 2000000, 2500000, '1-1102', 'Persediaan Furniture', 'Lemari arsip besi 4 pintu', 'SKU-LMR-001', 'BRG-008', 'Lion', 'LA-4P'),
  ('Rak', 'Rak Buku 5 Tingkat', 'Gudang B', 'Unit', 'RAK-BKU-001', 'CV Furniture Jaya', 800000, 'PPN 11%', 600000, 800000, '1-1102', 'Persediaan Furniture', 'Rak buku kayu 5 tingkat', 'SKU-RAK-001', 'BRG-009', 'Funika', 'RB-5T'),
  ...
  ('Spidol', 'Spidol Whiteboard', 'Gudang C', 'Pcs', 'SPD-WB-001', 'PT Kertas Nusantara', 8000, 'Non PPN', 6000, 8000, '1-1103', 'Persediaan Alat Tulis', 'Spidol whiteboard warna hitam', 'SKU-SPD-001', 'BRG-012', 'Snowman', 'WB-12'),
  ('Stapler', 'Stapler Joyko HD-10', 'Gudang C', 'Pcs', 'STP-JOY-001', 'PT Kertas Nusantara', 25000, 'Non PPN', 18000, 25000, '1-1103', 'Persediaan Alat Tulis', 'Stapler Joyko HD-10 kapasitas 50 lembar', 'SKU-STP-001', 'BRG-013', 'Joyko', 'HD-10'),
  ('Map', 'Map Plastik Folio', 'Gudang C', 'Pcs', 'MAP-FLO-001', 'PT Kertas Nusantara', 3000, 'Non PPN', 2000, 3000, '1-1103', 'Persediaan Alat Tulis', 'Map plastik folio warna biru', 'SKU-MAP-001', 'BRG-014', 'Bantex', 'MP-F'),
  
  -- Spare Parts
  ('Ban', 'Ban Mobil Bridgestone', 'Gudang D', 'Unit', 'BAN-BRG-001', 'PT Otomotif Sejahtera', 1200000, 'PPN 11%', 950000, 1200000, '1-1104', 'Persediaan Spare Parts', 'Ban mobil Bridgestone 185/65 R15', 'SKU-BAN-001', 'BRG-015', 'Bridgestone', 'BR-185-65-R15'),
  ('Oli', 'Oli Mesin Shell Helix', 'Gudang D', 'Liter', 'OLI-SHL-001', 'PT Otomotif Sejahtera', 85000, 'PPN 11%', 65000, 85000, '1-1104', 'Persediaan Spare Parts', 'Oli mesin Shell Helix HX7 10W-40', 'SKU-OLI-001', 'BRG-016', 'Shell', 'HX7-10W40'),
  ('Aki', 'Aki Mobil GS Astra', 'Gudang D', 'Unit', 'AKI-GSA-001', 'PT Otomotif Sejahtera', 850000, 'PPN 11%', 650000, 850000, '1-1104', 'Persediaan Spare Parts', 'Aki mobil GS Astra NS60 12V 45Ah', 'SKU-AKI-001', 'BRG-017', 'GS Astra', 'NS60'),
  ('Filter', 'Filter Udara Denso', 'Gudang D', 'Pcs', 'FLT-DNS-001', 'PT Otomotif Sejahtera', 150000, 'PPN 11%', 110000, 150000, '1-1104', 'Persediaan Spare Parts', 'Filter udara Denso untuk mobil sedan', 'SKU-FLT-001', 'BRG-018', 'Denso', 'AF-001')
